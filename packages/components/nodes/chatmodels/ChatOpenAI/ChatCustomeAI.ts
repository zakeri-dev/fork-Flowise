...
class ChatCustomeAI_ChatModels implements INode {
    label: string
    name: string
    version: number
    type: string
    ...
    constructor() {
        this.label = 'ChatCustomeAI'
        this.name = 'ChatCustomeAI'
        this.version = 8.0
        this.type = 'ChatCustomeAI'
...
module.exports = { nodeClass: ChatCustomeAI_ChatModels }
